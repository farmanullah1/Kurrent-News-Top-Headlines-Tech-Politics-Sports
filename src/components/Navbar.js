      ...
      <nav className="navbar navbar-expand-lg glass-navbar">
        <div className="container-fluid px-4">
          ...
          <NavLink 
            ...
            to="/"
          >
            {/* Fixed: single unified hover target on the wrapper only */}
            <div className="brand-logo-wrapper rounded-circle overflow-hidden bg-white shadow d-flex align-items-center justify-content-center">
              <img
                src={logo}
                alt="Kurrent News Logo"
                width="44"
                height="44"
                className="brand-logo object-fit-contain p-1"
                onError={(e) => {
          ...
          <div className="collapse navbar-collapse" id="navContent">
            ...
            <div className="d-flex align-items-center gap-3">
              ...
              <a
                ...
                aria-label="farmanullah1 on GitHub"
              >
                <GitHubIcon size={22} />
              </a>
